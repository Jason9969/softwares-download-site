...
export const apps: Category[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "万能五笔输入法", desc: "较早推出的五笔输入法，支持五笔拼音混合输入", recommend: 0, isDownloadable: true, url: "https://www.wnwb.com/index.html", favicon: "/wnwb.ico" },
            { name: "极品五笔输入法", desc: "国产五笔输入法，支持中文五笔编码输入", recommend: 0, isDownloadable: true, url: "http://www.jpwb.net/", favicon: "/jpwb.png" }
        ]
    },
    {
        category: "影音娱乐",
